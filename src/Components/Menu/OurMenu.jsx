...
export default function OurMenu() {
  return (
    <section id="best-menu" className="flex flex-col items-center justify-center text-xl space-y-12 -mx-16 px-16 bg-[#F4F4F4] py-16">
      <div className="text-center space-y-4">
        <h1 className="text-[#6D4F25] text-xl">BEST MENU</h1>
      </div>

      <div className="grid grid-cols-3 lg:gap-12 gap-6 items-center justify-center">
